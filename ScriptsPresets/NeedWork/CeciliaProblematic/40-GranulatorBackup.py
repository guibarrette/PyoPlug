...
# DSP
# grainenv = DataTable(3, [(0,0),(0.5,1),(1,0)])
grainenv = HannTable()
polyphony_spread = .7
number_of_voices = 8

amp_scl = Map(200, 1, "lin")
firstamp = amp_scl.set(num.get())
