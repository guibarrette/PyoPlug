...
//-----------------------------------------------------------------------------
// PyoEditor class implementation
//-----------------------------------------------------------------------------
PyoEditor::PyoEditor (AudioEffect *effect)
...
//-----------------------------------------------------------------------------
void PyoEditor::setParameter (VstInt32 index, float value)
{
	if (frame == 0)
		return;
...
//-----------------------------------------------------------------------------
void PyoEditor::valueChanged (CDrawContext* context, CControl* control)
{
